...
<p align="center">
  <img src="miniprogram-qr.jpg" alt="OpenRemote 小程序二维码" width="200">
</p>

微信扫码注册登录即可体验 OpenRemote 小程序，如需测试账号可在Issues留言。
...
> **国内网络提示：** 安装过程需要从 npm 和 GitHub 下载依赖（含 native 模块 `node-pty`），如遇网络问题可先切换镜像源：
> ```bash
